            ...
            <tr>
              ...
              <td>{{
                newsletter.publishedAt
                  ? (newsletter.publishedAt | date: 'short')
                  : '-'
              }}</td>
                  ...
                  >
                    <ng-template ngMenuContent>
                      ...
                      >
                        ...
                        <span>{{
                          newsletter.published ? 'Despublicar' : 'Publicar'
                        }}</span>
                      </button>
                      <button
                        ngMenuItem
            ...
            @if (newsletters.isLoading()) {
              ...
              <tr>
                <td colspan="7" class="text-center">
                  Sin boletines para este filtro
                </td>
              </tr>
            }
          }
        ...
        .watchQuery<{
          ...
          query: gql`
            query GetNewsletters(
              ...
              count: findManyNewslettersCount(
                search: $search
                schoolId: $schoolId
              )
              newsletters(
    ...
    this.#confirmation
      ...
      .pipe(
        ...
        switchMap(() =>
          this.#apollo.mutate({
            mutation: gql`
              mutation RemoveNewsletter($removeNewsletterId: String!) {
                removeNewsletter(id: $removeNewsletterId) {
                  id
                }
              }
            `,
